    ...
    <div className="flex flex-col min-h-screen">
      ...
      <motion.nav
        ...
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled
            ? 'bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-lg py-3'
            : 'bg-primary dark:bg-slate-950 py-5'
          }`}
      >
        <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className={`text-xl font-bold tracking-tight transition-colors ${isScrolled ? 'text-primary dark:text-white' : 'text-white'}`}>
          ...
          <div className="hidden md:flex items-center gap-10">
            <div className="flex items-center gap-8">
              <Link to="/" className={`nav-link group ${isScrolled ? '!text-slate-600 dark:!text-slate-300 hover:!text-primary' : ''}`}>
                <span className="w-1.5 h-1.5 rounded-full bg-secondary opacity-0 group-hover:opacity-100 transition-opacity" />
                Home
              </Link>
              <Link to="/explore" className={`nav-link group ${isScrolled ? '!text-slate-600 dark:!text-slate-300 hover:!text-primary' : ''}`}>
                <span className="w-1.5 h-1.5 rounded-full bg-secondary opacity-0 group-hover:opacity-100 transition-opacity" />
                Live Hub
              </Link>
            </div>
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Mobile Menu Toggle */}
            <button
              className={`md:hidden transition-colors ${isScrolled ? 'text-primary dark:text-white' : 'text-white'}`}
      ...
      {/* Footer */}
      <footer className="bg-slate-50 dark:bg-slate-900/50 border-t border-slate-200 dark:border-slate-800 py-16 mt-auto transition-colors duration-300">
        <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2 space-y-6">
            <div className="flex items-center gap-3">
              <div className="bg-white dark:bg-slate-800 p-1 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700">
          ...
          <div>
            <h4 className="text-primary dark:text-white font-bold mb-6 text-sm uppercase tracking-wider">Quick Links</h4>
            <ul className="space-y-3">
              <li><Link to="/explore" className="text-slate-500 dark:text-slate-400 hover:text-primary dark:hover:text-secondary transition-colors text-sm font-medium">Explore Events</Link></li>
              <li><Link to="/auth/club" className="text-slate-500 dark:text-slate-400 hover:text-primary dark:hover:text-secondary transition-colors text-sm font-medium">Clubs</Link></li>
              <li><Link to="/auth/hod" className="text-slate-500 dark:text-slate-400 hover:text-primary dark:hover:text-secondary transition-colors text-sm font-medium">HOD Portal</Link></li>
              <li><Link to="/auth/admin" className="text-slate-500 dark:text-slate-400 hover:text-primary dark:hover:text-secondary transition-colors text-sm font-medium">Admin</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-primary dark:text-white font-bold mb-6 text-sm uppercase tracking-wider">Contact</h4>
            <ul className="space-y-3 text-slate-500 dark:text-slate-400 text-sm font-medium">
              <li className="hover:text-primary dark:hover:text-secondary transition-colors cursor-pointer">support@smartcampus.edu</li>
              <li className="hover:text-primary dark:hover:text-secondary transition-colors cursor-pointer">+1 234 567 8900</li>
              <li className="hover:text-primary dark:hover:text-secondary transition-colors cursor-pointer">123 University Ave, Tech City</li>
            </ul>
          </div>
        </div>
        <div className="container mx-auto px-6 md:px-12 mt-16 pt-8 border-t border-slate-200 dark:border-slate-800 text-center text-slate-400 dark:text-slate-500 text-xs font-medium uppercase tracking-[0.2em]">
